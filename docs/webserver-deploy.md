...
This repo includes a deploy tool that rsyncs only what the server needs.
...
`scripts/deploy-host/setup-domain-ssl.sh --domain <newhost.example.com> --proxy-pass http://127.0.0.1:<PORT>`
